...
namespace SignificantTradeSS{
    ...
    public partial class VwAspnetMembershipUser : ReadOnlyRecord<VwAspnetMembershipUser>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vw_aspnet_MembershipUsers", TableType.View, DataService.GetInstance("SignificantTradeSS"));
                ...
                DataService.Providers["SignificantTradeSS"].AddSchema("vw_aspnet_MembershipUsers",schema);
            }
        }
        #endregion
