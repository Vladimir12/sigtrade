...
namespace SignificantTradeSS{
    ...
    public partial class VwAspnetWebPartStatePath : ReadOnlyRecord<VwAspnetWebPartStatePath>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vw_aspnet_WebPartState_Paths", TableType.View, DataService.GetInstance("SignificantTradeSS"));
                ...
                DataService.Providers["SignificantTradeSS"].AddSchema("vw_aspnet_WebPartState_Paths",schema);
            }
        }
        #endregion
