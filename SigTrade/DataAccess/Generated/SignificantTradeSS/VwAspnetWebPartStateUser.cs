...
namespace SignificantTradeSS{
    ...
    public partial class VwAspnetWebPartStateUser : ReadOnlyRecord<VwAspnetWebPartStateUser>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vw_aspnet_WebPartState_User", TableType.View, DataService.GetInstance("SignificantTradeSS"));
                ...
                DataService.Providers["SignificantTradeSS"].AddSchema("vw_aspnet_WebPartState_User",schema);
            }
        }
        #endregion
