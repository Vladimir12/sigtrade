...
namespace SignificantTradeSS
{
	...
	/// </summary>
    [Serializable]
	public partial class GeneralLibCollection : ActiveList<GeneralLib, GeneralLibCollection>
	{	   
	...
	/// </summary>
	[Serializable]
	public partial class GeneralLib : ActiveRecord<GeneralLib>, IActiveRecord
	{
		...
		public GeneralLib(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public GeneralLib(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("GeneralLib", TableType.Table, DataService.GetInstance("SignificantTradeSS"));
				...
				DataService.Providers["SignificantTradeSS"].AddSchema("GeneralLib",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(string varDescription,string varType,string varExternalRef,DateTime? varDateAdded,bool? varValid)
		{
			...
			item.ExternalRef = varExternalRef;
		...
		/// </summary>
		public static void Update(int varId,string varDescription,string varType,string varExternalRef,DateTime? varDateAdded,bool? varValid)
		{
			GeneralLib item = new GeneralLib();
