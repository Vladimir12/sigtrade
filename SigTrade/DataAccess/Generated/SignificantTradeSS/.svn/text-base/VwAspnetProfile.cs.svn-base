...
namespace SignificantTradeSS{
    ...
    public partial class VwAspnetProfile : ReadOnlyRecord<VwAspnetProfile>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vw_aspnet_Profiles", TableType.View, DataService.GetInstance("SignificantTradeSS"));
                ...
                DataService.Providers["SignificantTradeSS"].AddSchema("vw_aspnet_Profiles",schema);
            }
        }
        #endregion
