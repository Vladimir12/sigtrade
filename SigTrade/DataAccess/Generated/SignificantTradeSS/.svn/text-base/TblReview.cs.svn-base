...
namespace SignificantTradeSS
{
	...
	/// </summary>
    [Serializable]
	public partial class TblReviewCollection : ActiveList<TblReview, TblReviewCollection>
	{	   
	...
	/// </summary>
	[Serializable]
	public partial class TblReview : ActiveRecord<TblReview>, IActiveRecord
	{
		...
		public TblReview(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		/// </summary>
		public static void Insert(int? varPhaseID,int? varCountryID,int? varTaxonID,int? varTaxonLevel,DateTime? varDateAdded,int? varAddedBy,int? varKingdomID,bool varDeleted,DateTime? varDeletedDate,int? varCommitteeID,DateTime? varReviewDate,int? varReviewType,int? varConcernID,int? varOldSigMainID)
		{
			...
			item.TaxonID = varTaxonID;
			
			item.TaxonLevel = varTaxonLevel;
			
			item.DateAdded = varDateAdded;
			
			item.AddedBy = varAddedBy;
			
			item.KingdomID = varKingdomID;
			...
			item.ReviewType = varReviewType;
			
			item.ConcernID = varConcernID;
			
			item.OldSigMainID = varOldSigMainID;
		...
		/// </summary>
		public static void Update(int varId,int? varPhaseID,int? varCountryID,int? varTaxonID,int? varTaxonLevel,DateTime? varDateAdded,int? varAddedBy,int? varKingdomID,bool varDeleted,DateTime? varDeletedDate,int? varCommitteeID,DateTime? varReviewDate,int? varReviewType,int? varConcernID,int? varOldSigMainID)
		{
			TblReview item = new TblReview();
