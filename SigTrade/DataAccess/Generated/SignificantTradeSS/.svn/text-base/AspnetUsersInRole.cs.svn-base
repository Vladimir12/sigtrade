...
namespace SignificantTradeSS
{
	...
	public partial class AspnetUsersInRole : ActiveRecord<AspnetUsersInRole>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_UsersInRoles", TableType.Table, DataService.GetInstance("SignificantTradeSS"));
				...
				DataService.Providers["SignificantTradeSS"].AddSchema("aspnet_UsersInRoles",schema);
			}
		}
		#endregion
		...
		/// 
		/// </summary>
		public SignificantTradeSS.AspnetRole AspnetRole
		{
			get { return SignificantTradeSS.AspnetRole.FetchByID(this.RoleId); }
