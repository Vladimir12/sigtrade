...
namespace SignificantTradeSS{
    ...
    public partial class VwGenusSpecy : ReadOnlyRecord<VwGenusSpecy>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vwGenusSpecies", TableType.View, DataService.GetInstance("SignificantTradeSS"));
                ...
                DataService.Providers["SignificantTradeSS"].AddSchema("vwGenusSpecies",schema);
            }
        }
        #endregion
