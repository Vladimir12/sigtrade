...
namespace SignificantTradeSS{
    ...
    public partial class VwAspnetUser : ReadOnlyRecord<VwAspnetUser>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vw_aspnet_Users", TableType.View, DataService.GetInstance("SignificantTradeSS"));
                ...
                DataService.Providers["SignificantTradeSS"].AddSchema("vw_aspnet_Users",schema);
            }
        }
        #endregion
