...
namespace SignificantTradeSS
{
	...
	public partial class AspnetUser : ActiveRecord<AspnetUser>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_Users", TableType.Table, DataService.GetInstance("SignificantTradeSS"));
				...
				DataService.Providers["SignificantTradeSS"].AddSchema("aspnet_Users",schema);
			}
		}
		#endregion
		...
		public SignificantTradeSS.AspnetMembershipCollection AspnetMembershipRecords()
		{
			return new SignificantTradeSS.AspnetMembershipCollection().Where(AspnetMembership.Columns.UserId, UserId).Load();
		}
		public SignificantTradeSS.AspnetPersonalizationPerUserCollection AspnetPersonalizationPerUserRecords()
		{
			return new SignificantTradeSS.AspnetPersonalizationPerUserCollection().Where(AspnetPersonalizationPerUser.Columns.UserId, UserId).Load();
		}
		public SignificantTradeSS.AspnetProfileCollection AspnetProfileRecords()
		{
			return new SignificantTradeSS.AspnetProfileCollection().Where(AspnetProfile.Columns.UserId, UserId).Load();
		}
		public SignificantTradeSS.AspnetUsersInRoleCollection AspnetUsersInRoles()
		{
			return new SignificantTradeSS.AspnetUsersInRoleCollection().Where(AspnetUsersInRole.Columns.UserId, UserId).Load();
		}
		#endregion
		...
		/// 
		/// </summary>
		public SignificantTradeSS.AspnetApplication AspnetApplication
		{
			get { return SignificantTradeSS.AspnetApplication.FetchByID(this.ApplicationId); }
		...
		public SignificantTradeSS.AspnetRoleCollection GetAspnetRoleCollection() { return AspnetUser.GetAspnetRoleCollection(this.UserId); }
