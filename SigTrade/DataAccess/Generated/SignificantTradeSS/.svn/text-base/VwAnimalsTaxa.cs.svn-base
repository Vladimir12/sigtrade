...
namespace SignificantTradeSS{
    /// <summary>
    /// Strongly-typed collection for the VwAnimalsTaxa class.
    /// </summary>
    [Serializable]
    public partial class VwAnimalsTaxaCollection : ReadOnlyList<VwAnimalsTaxa, VwAnimalsTaxaCollection>
    {        
        public VwAnimalsTaxaCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the vwAnimalsTaxa view.
    /// </summary>
    [Serializable]
    public partial class VwAnimalsTaxa : ReadOnlyRecord<VwAnimalsTaxa>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vwAnimalsTaxa", TableType.View, DataService.GetInstance("SignificantTradeSS"));
                ...
                DataService.Providers["SignificantTradeSS"].AddSchema("vwAnimalsTaxa",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public VwAnimalsTaxa()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public VwAnimalsTaxa(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public VwAnimalsTaxa(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public VwAnimalsTaxa(string columnName, object columnValue)
        {
            SetSQLProps();
