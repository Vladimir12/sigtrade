...
namespace SignificantTradeSS
{
	...
	/// </summary>
    [Serializable]
	public partial class DecisionCollection : ActiveList<Decision, DecisionCollection>
	{	   
	...
	/// </summary>
	[Serializable]
	public partial class Decision : ActiveRecord<Decision>, IActiveRecord
	{
		...
		public Decision(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Decisions", TableType.Table, DataService.GetInstance("SignificantTradeSS"));
				...
				DataService.Providers["SignificantTradeSS"].AddSchema("Decisions",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(int? varParagraphActionID,int? varDecisionType,string varNotes,DateTime? varSuspensionDate,int? varTradeTerms,int? varSuspensionCommitteeID,DateTime? varSuspensionLiftDate,int? varLigftingCommitteeID,DateTime? varAddedDate,DateTime? varModifiedDate,bool? varDeleted,DateTime? varDeletedDate)
		{
			Decision item = new Decision();
			
			item.ParagraphActionID = varParagraphActionID;
			
			item.DecisionType = varDecisionType;
			
			item.Notes = varNotes;
			
			item.SuspensionDate = varSuspensionDate;
			
			item.TradeTerms = varTradeTerms;
			
			item.SuspensionCommitteeID = varSuspensionCommitteeID;
			
			item.SuspensionLiftDate = varSuspensionLiftDate;
			
			item.LigftingCommitteeID = varLigftingCommitteeID;
		...
		/// </summary>
		public static void Update(int varId,int? varParagraphActionID,int? varDecisionType,string varNotes,DateTime? varSuspensionDate,int? varTradeTerms,int? varSuspensionCommitteeID,DateTime? varSuspensionLiftDate,int? varLigftingCommitteeID,DateTime? varAddedDate,DateTime? varModifiedDate,bool? varDeleted,DateTime? varDeletedDate)
		{
			Decision item = new Decision();
