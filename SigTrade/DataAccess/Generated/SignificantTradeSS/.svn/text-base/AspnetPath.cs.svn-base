...
namespace SignificantTradeSS
{
	...
	public partial class AspnetPath : ActiveRecord<AspnetPath>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_Paths", TableType.Table, DataService.GetInstance("SignificantTradeSS"));
				...
				DataService.Providers["SignificantTradeSS"].AddSchema("aspnet_Paths",schema);
			}
		}
		#endregion
		...
		public SignificantTradeSS.AspnetPersonalizationAllUserCollection AspnetPersonalizationAllUsers()
		{
			return new SignificantTradeSS.AspnetPersonalizationAllUserCollection().Where(AspnetPersonalizationAllUser.Columns.PathId, PathId).Load();
		}
		public SignificantTradeSS.AspnetPersonalizationPerUserCollection AspnetPersonalizationPerUserRecords()
		{
			return new SignificantTradeSS.AspnetPersonalizationPerUserCollection().Where(AspnetPersonalizationPerUser.Columns.PathId, PathId).Load();
		}
		#endregion
