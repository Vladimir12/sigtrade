...
namespace SignificantTradeSS
{
	...
	public partial class AspnetProfile : ActiveRecord<AspnetProfile>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_Profile", TableType.Table, DataService.GetInstance("SignificantTradeSS"));
				...
				DataService.Providers["SignificantTradeSS"].AddSchema("aspnet_Profile",schema);
			}
		}
		#endregion
