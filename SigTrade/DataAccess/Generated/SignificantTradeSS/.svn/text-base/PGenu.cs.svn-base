...
{
	/// <summary>
	/// Strongly-typed collection for the PGenu class.
	/// </summary>
    [Serializable]
	public partial class PGenuCollection : ActiveList<PGenu, PGenuCollection>
	{	   
		public PGenuCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>PGenuCollection</returns>
		public PGenuCollection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the PGenus table.
	/// </summary>
	[Serializable]
	public partial class PGenu : ActiveRecord<PGenu>, IActiveRecord
	{
		...
		public PGenu(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public PGenu(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("PGenus", TableType.Table, DataService.GetInstance("SignificantTradeSS"));
				...
				colvarGenRecID.IsPrimaryKey = true;
				...
				DataService.Providers["SignificantTradeSS"].AddSchema("PGenus",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Update(int varGenRecID,int? varGenFamRecID,string varGenName,string varGenAuthor,string varGenStatus,int? varGenNoSpecies,DateTime? varGenAdded,DateTime? varGenModified,int? varGenByWho)
		{
			PGenu item = new PGenu();
