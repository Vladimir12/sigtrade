...
namespace SignificantTradeSS{
    /// <summary>
    /// Strongly-typed collection for the VwCountriesOld class.
    /// </summary>
    [Serializable]
    public partial class VwCountriesOldCollection : ReadOnlyList<VwCountriesOld, VwCountriesOldCollection>
    {        
        public VwCountriesOldCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the vwCountries_old view.
    /// </summary>
    [Serializable]
    public partial class VwCountriesOld : ReadOnlyRecord<VwCountriesOld>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vwCountries_old", TableType.View, DataService.GetInstance("SignificantTradeSS"));
                ...
                colvarCtyISO3166.IsNullable = true;
                ...
                DataService.Providers["SignificantTradeSS"].AddSchema("vwCountries_old",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public VwCountriesOld()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public VwCountriesOld(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public VwCountriesOld(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public VwCountriesOld(string columnName, object columnValue)
        {
            SetSQLProps();
