...
namespace SignificantTradeSS{
    ...
    public partial class VwAspnetUsersInRole : ReadOnlyRecord<VwAspnetUsersInRole>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vw_aspnet_UsersInRoles", TableType.View, DataService.GetInstance("SignificantTradeSS"));
                ...
                DataService.Providers["SignificantTradeSS"].AddSchema("vw_aspnet_UsersInRoles",schema);
            }
        }
        #endregion
