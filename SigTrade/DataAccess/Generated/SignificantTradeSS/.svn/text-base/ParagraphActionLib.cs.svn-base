...
namespace SignificantTradeSS
{
	...
	/// </summary>
    [Serializable]
	public partial class ParagraphActionLibCollection : ActiveList<ParagraphActionLib, ParagraphActionLibCollection>
	{	   
	...
	/// </summary>
	[Serializable]
	public partial class ParagraphActionLib : ActiveRecord<ParagraphActionLib>, IActiveRecord
	{
		...
		public ParagraphActionLib(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public ParagraphActionLib(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ParagraphActionLib", TableType.Table, DataService.GetInstance("SignificantTradeSS"));
				...
				TableSchema.TableColumn colvarConcernVisible = new TableSchema.TableColumn(schema);
				colvarConcernVisible.ColumnName = "ConcernVisible";
				colvarConcernVisible.DataType = DbType.Boolean;
				colvarConcernVisible.MaxLength = 0;
				colvarConcernVisible.AutoIncrement = false;
				colvarConcernVisible.IsNullable = true;
				colvarConcernVisible.IsPrimaryKey = false;
				colvarConcernVisible.IsForeignKey = false;
				colvarConcernVisible.IsReadOnly = false;
				
						colvarConcernVisible.DefaultSetting = @"((1))";
				colvarConcernVisible.ForeignKeyTableName = "";
				schema.Columns.Add(colvarConcernVisible);
				
				BaseSchema = schema;
				//add this schema to the provider
				//so we can query it later
				DataService.Providers["SignificantTradeSS"].AddSchema("ParagraphActionLib",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("ConcernVisible")]
		[Bindable(true)]
		public bool? ConcernVisible 
		{
			get { return GetColumnValue<bool?>(Columns.ConcernVisible); }
			set { SetColumnValue(Columns.ConcernVisible, value); }
		}
		...
		/// </summary>
		public static void Insert(string varParagraph,string varActionOrder,string varAction,bool varDeleted,bool varConcernRequired,bool varRecommendations,bool varDecisions,bool varBranch,string varBranchLink,int? varSequence,string varDescription,int varDeadlineDays,bool? varConcernVisible)
		{
			ParagraphActionLib item = new ParagraphActionLib();
			
			item.Paragraph = varParagraph;
			
			item.ActionOrder = varActionOrder;
			
			item.Action = varAction;
			
			item.Deleted = varDeleted;
			
			item.ConcernRequired = varConcernRequired;
			
			item.Recommendations = varRecommendations;
			
			item.Decisions = varDecisions;
			
			item.Branch = varBranch;
			
			item.BranchLink = varBranchLink;
			
			item.Sequence = varSequence;
			
			item.Description = varDescription;
			
			item.DeadlineDays = varDeadlineDays;
			
			item.ConcernVisible = varConcernVisible;
		...
		/// </summary>
		public static void Update(int varId,string varParagraph,string varActionOrder,string varAction,bool varDeleted,bool varConcernRequired,bool varRecommendations,bool varDecisions,bool varBranch,string varBranchLink,int? varSequence,string varDescription,int varDeadlineDays,bool? varConcernVisible)
		{
			ParagraphActionLib item = new ParagraphActionLib();
        ...
        public static TableSchema.TableColumn ConcernVisibleColumn
        {
		...
		public struct Columns
		{
			 ...
			 public static string ConcernVisible = @"ConcernVisible";
