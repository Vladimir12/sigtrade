...
namespace SignificantTradeSS{
    ...
    public partial class VwAspnetWebPartStateShared : ReadOnlyRecord<VwAspnetWebPartStateShared>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vw_aspnet_WebPartState_Shared", TableType.View, DataService.GetInstance("SignificantTradeSS"));
                ...
                DataService.Providers["SignificantTradeSS"].AddSchema("vw_aspnet_WebPartState_Shared",schema);
            }
        }
        #endregion
