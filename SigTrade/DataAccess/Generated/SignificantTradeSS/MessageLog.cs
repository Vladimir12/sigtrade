...
namespace SignificantTradeSS
{
	...
	/// </summary>
    [Serializable]
	public partial class MessageLogCollection : ActiveList<MessageLog, MessageLogCollection>
	{	   
	...
	/// </summary>
	[Serializable]
	public partial class MessageLog : ActiveRecord<MessageLog>, IActiveRecord
	{
		...
		public MessageLog(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public MessageLog(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("MessageLog", TableType.Table, DataService.GetInstance("SignificantTradeSS"));
				...
				DataService.Providers["SignificantTradeSS"].AddSchema("MessageLog",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(string varTitle,string varBody,string varSentTo,DateTime varSentAt,bool varDeleted)
		{
			...
			item.SentTo = varSentTo;
			
			item.SentAt = varSentAt;
		...
		/// </summary>
		public static void Update(int varId,string varTitle,string varBody,string varSentTo,DateTime varSentAt,bool varDeleted)
		{
			MessageLog item = new MessageLog();
