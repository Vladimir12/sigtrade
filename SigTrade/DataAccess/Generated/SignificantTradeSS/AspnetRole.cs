...
namespace SignificantTradeSS
{
	...
	public partial class AspnetRole : ActiveRecord<AspnetRole>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_Roles", TableType.Table, DataService.GetInstance("SignificantTradeSS"));
				...
				DataService.Providers["SignificantTradeSS"].AddSchema("aspnet_Roles",schema);
			}
		}
		#endregion
		...
		{
			return new SignificantTradeSS.AspnetUsersInRoleCollection().Where(AspnetUsersInRole.Columns.RoleId, RoleId).Load();
		}
		#endregion
		...
		public SignificantTradeSS.AspnetUserCollection GetAspnetUserCollection() { return AspnetRole.GetAspnetUserCollection(this.RoleId); }
