...
namespace SignificantTradeSS{
    ...
    public partial class VwAnimalsTaxaOld : ReadOnlyRecord<VwAnimalsTaxaOld>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vwAnimalsTaxa_old", TableType.View, DataService.GetInstance("SignificantTradeSS"));
                ...
                DataService.Providers["SignificantTradeSS"].AddSchema("vwAnimalsTaxa_old",schema);
            }
        }
        #endregion
