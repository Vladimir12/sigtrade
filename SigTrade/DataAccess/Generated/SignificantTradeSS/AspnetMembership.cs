...
namespace SignificantTradeSS
{
	...
	public partial class AspnetMembership : ActiveRecord<AspnetMembership>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_Membership", TableType.Table, DataService.GetInstance("SignificantTradeSS"));
				...
				DataService.Providers["SignificantTradeSS"].AddSchema("aspnet_Membership",schema);
			}
		}
		#endregion
		...
		/// 
		/// </summary>
		public SignificantTradeSS.AspnetUser AspnetUser
		{
			get { return SignificantTradeSS.AspnetUser.FetchByID(this.UserId); }
