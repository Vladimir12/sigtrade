...
namespace SignificantTradeSS
{
	...
	/// </summary>
    [Serializable]
	public partial class AFamilyCollection : ActiveList<AFamily, AFamilyCollection>
	{	   
	...
	/// </summary>
	[Serializable]
	public partial class AFamily : ActiveRecord<AFamily>, IActiveRecord
	{
		...
		public AFamily(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("AFamily", TableType.Table, DataService.GetInstance("SignificantTradeSS"));
				...
				DataService.Providers["SignificantTradeSS"].AddSchema("AFamily",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(int varFamRecID,int? varFamOrdRecID,string varFamName,string varFamAuthor,float? varFamSortCodeEU,float? varFamSortCodeRL,int? varFamOrder,string varFamStatus,string varFamCommonName,int? varFamNoGenera,string varFamCITESAppendix,DateTime? varFamDateListed,DateTime? varFamAdded,DateTime? varFamModified,int? varFamByWho)
		{
