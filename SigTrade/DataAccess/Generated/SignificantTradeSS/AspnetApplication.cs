...
namespace SignificantTradeSS
{
	...
	public partial class AspnetApplication : ActiveRecord<AspnetApplication>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_Applications", TableType.Table, DataService.GetInstance("SignificantTradeSS"));
				...
				DataService.Providers["SignificantTradeSS"].AddSchema("aspnet_Applications",schema);
			}
		}
		#endregion
		...
		{
			return new SignificantTradeSS.AspnetMembershipCollection().Where(AspnetMembership.Columns.ApplicationId, ApplicationId).Load();
		}
		public SignificantTradeSS.AspnetPathCollection AspnetPaths()
		{
			return new SignificantTradeSS.AspnetPathCollection().Where(AspnetPath.Columns.ApplicationId, ApplicationId).Load();
		}
		public SignificantTradeSS.AspnetRoleCollection AspnetRoles()
		{
			return new SignificantTradeSS.AspnetRoleCollection().Where(AspnetRole.Columns.ApplicationId, ApplicationId).Load();
		}
		public SignificantTradeSS.AspnetUserCollection AspnetUsers()
		{
			return new SignificantTradeSS.AspnetUserCollection().Where(AspnetUser.Columns.ApplicationId, ApplicationId).Load();
		}
		#endregion
