...
namespace SignificantTradeSS
{
	...
	public partial class AspnetPersonalizationAllUser : ActiveRecord<AspnetPersonalizationAllUser>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_PersonalizationAllUsers", TableType.Table, DataService.GetInstance("SignificantTradeSS"));
				...
				DataService.Providers["SignificantTradeSS"].AddSchema("aspnet_PersonalizationAllUsers",schema);
			}
		}
		#endregion
		...
		/// 
		/// </summary>
		public SignificantTradeSS.AspnetPath AspnetPath
		{
			get { return SignificantTradeSS.AspnetPath.FetchByID(this.PathId); }
