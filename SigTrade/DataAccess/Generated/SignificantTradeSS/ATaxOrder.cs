...
namespace SignificantTradeSS
{
	...
	/// </summary>
    [Serializable]
	public partial class ATaxOrderCollection : ActiveList<ATaxOrder, ATaxOrderCollection>
	{	   
	...
	/// </summary>
	[Serializable]
	public partial class ATaxOrder : ActiveRecord<ATaxOrder>, IActiveRecord
	{
		...
		public ATaxOrder(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ATaxOrder", TableType.Table, DataService.GetInstance("SignificantTradeSS"));
				...
				DataService.Providers["SignificantTradeSS"].AddSchema("ATaxOrder",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(int varOrdRecID,int? varOrdClaRecID,string varOrdName,string varOrdRecStatus,int? varOrdOrder,DateTime? varOrdAdded,DateTime? varOrdModified,int? varOrdByWho)
		{
			ATaxOrder item = new ATaxOrder();
			
			item.OrdRecID = varOrdRecID;
			
			item.OrdClaRecID = varOrdClaRecID;
			
			item.OrdName = varOrdName;
			
			item.OrdRecStatus = varOrdRecStatus;
			
			item.OrdOrder = varOrdOrder;
			
			item.OrdAdded = varOrdAdded;
			
			item.OrdModified = varOrdModified;
			
			item.OrdByWho = varOrdByWho;
		...
		/// </summary>
		public static void Update(int varOrdRecID,int? varOrdClaRecID,string varOrdName,string varOrdRecStatus,int? varOrdOrder,DateTime? varOrdAdded,DateTime? varOrdModified,int? varOrdByWho)
		{
			ATaxOrder item = new ATaxOrder();
