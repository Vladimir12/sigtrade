...
{
	/// <summary>
	/// Strongly-typed collection for the PFamily class.
	/// </summary>
    [Serializable]
	public partial class PFamilyCollection : ActiveList<PFamily, PFamilyCollection>
	{	   
		public PFamilyCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>PFamilyCollection</returns>
		public PFamilyCollection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the PFamily table.
	/// </summary>
	[Serializable]
	public partial class PFamily : ActiveRecord<PFamily>, IActiveRecord
	{
		...
		public PFamily(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public PFamily(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("PFamily", TableType.Table, DataService.GetInstance("SignificantTradeSS"));
				...
				DataService.Providers["SignificantTradeSS"].AddSchema("PFamily",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(int varFamRecID,int? varFamOrdRecID,string varFamName,string varFamAuthor,float? varFamSortCodeEU,float? varFamSortCodeRL,string varFamStatus,string varFamCommonName,int? varFamNoGenera,string varFamCITESAppendix,DateTime? varFamDateListed,int? varFamOrder,DateTime? varFamAdded,DateTime? varFamModified,int? varFamByWho)
		{
			PFamily item = new PFamily();
			
			item.FamRecID = varFamRecID;
			
			item.FamOrdRecID = varFamOrdRecID;
			
			item.FamName = varFamName;
			
			item.FamAuthor = varFamAuthor;
			
			item.FamSortCodeEU = varFamSortCodeEU;
			
			item.FamSortCodeRL = varFamSortCodeRL;
			
			item.FamStatus = varFamStatus;
			
			item.FamCommonName = varFamCommonName;
			
			item.FamNoGenera = varFamNoGenera;
			
			item.FamCITESAppendix = varFamCITESAppendix;
			
			item.FamDateListed = varFamDateListed;
			
			item.FamOrder = varFamOrder;
			
			item.FamAdded = varFamAdded;
			
			item.FamModified = varFamModified;
			
			item.FamByWho = varFamByWho;
		...
		/// </summary>
		public static void Update(int varFamRecID,int? varFamOrdRecID,string varFamName,string varFamAuthor,float? varFamSortCodeEU,float? varFamSortCodeRL,string varFamStatus,string varFamCommonName,int? varFamNoGenera,string varFamCITESAppendix,DateTime? varFamDateListed,int? varFamOrder,DateTime? varFamAdded,DateTime? varFamModified,int? varFamByWho)
		{
			PFamily item = new PFamily();
