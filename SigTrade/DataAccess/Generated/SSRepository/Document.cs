...
namespace SignificantTradeSSRepository
{
	...
	/// </summary>
    [Serializable]
	public partial class DocumentCollection : RepositoryList<Document, DocumentCollection>
	{	   
	...
	/// </summary>
	[Serializable]
	public partial class Document : RepositoryRecord<Document>, IRecordBase
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Documents", TableType.Table, DataService.GetInstance("SSRepository"));
				...
				DataService.Providers["SSRepository"].AddSchema("Documents",schema);
			}
		}
		#endregion
