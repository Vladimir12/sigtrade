...
namespace SignificantTradeSSRepository{
    ...
    public partial class VwCountriesOld : ReadOnlyRecord<VwCountriesOld>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vwCountries_old", TableType.View, DataService.GetInstance("SSRepository"));
                ...
                DataService.Providers["SSRepository"].AddSchema("vwCountries_old",schema);
            }
        }
        #endregion
