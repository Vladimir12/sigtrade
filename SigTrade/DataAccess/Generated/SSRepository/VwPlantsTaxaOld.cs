...
namespace SignificantTradeSSRepository{
    ...
    public partial class VwPlantsTaxaOld : ReadOnlyRecord<VwPlantsTaxaOld>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vwPlantsTaxa_old", TableType.View, DataService.GetInstance("SSRepository"));
                ...
                DataService.Providers["SSRepository"].AddSchema("vwPlantsTaxa_old",schema);
            }
        }
        #endregion
