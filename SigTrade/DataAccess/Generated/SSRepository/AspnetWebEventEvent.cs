...
namespace SignificantTradeSSRepository
{
	...
	/// </summary>
    [Serializable]
	public partial class AspnetWebEventEventCollection : RepositoryList<AspnetWebEventEvent, AspnetWebEventEventCollection>
	{	   
	...
	/// </summary>
	[Serializable]
	public partial class AspnetWebEventEvent : RepositoryRecord<AspnetWebEventEvent>, IRecordBase
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_WebEvent_Events", TableType.Table, DataService.GetInstance("SSRepository"));
				...
				DataService.Providers["SSRepository"].AddSchema("aspnet_WebEvent_Events",schema);
			}
		}
		#endregion
