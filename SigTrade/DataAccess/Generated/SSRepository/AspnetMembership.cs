...
namespace SignificantTradeSSRepository
{
	...
	/// </summary>
    [Serializable]
	public partial class AspnetMembershipCollection : RepositoryList<AspnetMembership, AspnetMembershipCollection>
	{	   
	...
	/// </summary>
	[Serializable]
	public partial class AspnetMembership : RepositoryRecord<AspnetMembership>, IRecordBase
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_Membership", TableType.Table, DataService.GetInstance("SSRepository"));
				...
				DataService.Providers["SSRepository"].AddSchema("aspnet_Membership",schema);
			}
		}
		#endregion
