...
namespace SignificantTradeSSRepository
{
	...
	/// </summary>
    [Serializable]
	public partial class PGenuCollection : RepositoryList<PGenu, PGenuCollection>
	{	   
	...
	/// </summary>
	[Serializable]
	public partial class PGenu : RepositoryRecord<PGenu>, IRecordBase
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("PGenus", TableType.Table, DataService.GetInstance("SSRepository"));
				...
				DataService.Providers["SSRepository"].AddSchema("PGenus",schema);
			}
		}
		#endregion
