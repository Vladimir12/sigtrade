...
namespace SignificantTradeSSRepository
{
	...
	/// </summary>
    [Serializable]
	public partial class AspnetPersonalizationAllUserCollection : RepositoryList<AspnetPersonalizationAllUser, AspnetPersonalizationAllUserCollection>
	{	   
	...
	/// </summary>
	[Serializable]
	public partial class AspnetPersonalizationAllUser : RepositoryRecord<AspnetPersonalizationAllUser>, IRecordBase
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_PersonalizationAllUsers", TableType.Table, DataService.GetInstance("SSRepository"));
				...
				DataService.Providers["SSRepository"].AddSchema("aspnet_PersonalizationAllUsers",schema);
			}
		}
		#endregion
