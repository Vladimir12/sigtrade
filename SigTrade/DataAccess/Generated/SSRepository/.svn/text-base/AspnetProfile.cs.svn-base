...
namespace SignificantTradeSSRepository
{
	...
	/// </summary>
    [Serializable]
	public partial class AspnetProfileCollection : RepositoryList<AspnetProfile, AspnetProfileCollection>
	{	   
	...
	/// </summary>
	[Serializable]
	public partial class AspnetProfile : RepositoryRecord<AspnetProfile>, IRecordBase
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_Profile", TableType.Table, DataService.GetInstance("SSRepository"));
				...
				DataService.Providers["SSRepository"].AddSchema("aspnet_Profile",schema);
			}
		}
		#endregion
