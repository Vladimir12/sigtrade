...
namespace SignificantTradeSSRepository{
    ...
    public partial class VwPDistribCty : ReadOnlyRecord<VwPDistribCty>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vwPDistribCty", TableType.View, DataService.GetInstance("SSRepository"));
                ...
                DataService.Providers["SSRepository"].AddSchema("vwPDistribCty",schema);
            }
        }
        #endregion
