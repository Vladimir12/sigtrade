...
namespace SignificantTradeSSRepository{
    ...
    public partial class VwCountry : ReadOnlyRecord<VwCountry>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vwCountries", TableType.View, DataService.GetInstance("SSRepository"));
                ...
                DataService.Providers["SSRepository"].AddSchema("vwCountries",schema);
            }
        }
        #endregion
