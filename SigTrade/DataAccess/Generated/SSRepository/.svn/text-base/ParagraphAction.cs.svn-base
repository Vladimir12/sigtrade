...
namespace SignificantTradeSSRepository
{
	...
	/// </summary>
    [Serializable]
	public partial class ParagraphActionCollection : RepositoryList<ParagraphAction, ParagraphActionCollection>
	{	   
	...
	/// </summary>
	[Serializable]
	public partial class ParagraphAction : RepositoryRecord<ParagraphAction>, IRecordBase
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ParagraphAction", TableType.Table, DataService.GetInstance("SSRepository"));
				...
				DataService.Providers["SSRepository"].AddSchema("ParagraphAction",schema);
			}
		}
		#endregion
