...
namespace SignificantTradeSSRepository
{
	...
	/// </summary>
    [Serializable]
	public partial class AspnetSchemaVersionCollection : RepositoryList<AspnetSchemaVersion, AspnetSchemaVersionCollection>
	{	   
	...
	/// </summary>
	[Serializable]
	public partial class AspnetSchemaVersion : RepositoryRecord<AspnetSchemaVersion>, IRecordBase
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_SchemaVersions", TableType.Table, DataService.GetInstance("SSRepository"));
				...
				DataService.Providers["SSRepository"].AddSchema("aspnet_SchemaVersions",schema);
			}
		}
		#endregion
