...
namespace SignificantTradeSSRepository
{
	...
	/// </summary>
    [Serializable]
	public partial class PFamilyCollection : RepositoryList<PFamily, PFamilyCollection>
	{	   
	...
	/// </summary>
	[Serializable]
	public partial class PFamily : RepositoryRecord<PFamily>, IRecordBase
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("PFamily", TableType.Table, DataService.GetInstance("SSRepository"));
				...
				DataService.Providers["SSRepository"].AddSchema("PFamily",schema);
			}
		}
		#endregion
