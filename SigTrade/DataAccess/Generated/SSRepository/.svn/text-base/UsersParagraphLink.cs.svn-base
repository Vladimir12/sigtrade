...
namespace SignificantTradeSSRepository
{
	...
	/// </summary>
    [Serializable]
	public partial class UsersParagraphLinkCollection : RepositoryList<UsersParagraphLink, UsersParagraphLinkCollection>
	{	   
	...
	/// </summary>
	[Serializable]
	public partial class UsersParagraphLink : RepositoryRecord<UsersParagraphLink>, IRecordBase
	{
