...
namespace SignificantTradeSSRepository{
    ...
    public partial class VwCountrySpecy : ReadOnlyRecord<VwCountrySpecy>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vwCountrySpecies", TableType.View, DataService.GetInstance("SSRepository"));
                ...
                DataService.Providers["SSRepository"].AddSchema("vwCountrySpecies",schema);
            }
        }
        #endregion
