...
namespace SignificantTradeSSRepository
{
	...
	/// </summary>
    [Serializable]
	public partial class AnimalsSpecyCollection : RepositoryList<AnimalsSpecy, AnimalsSpecyCollection>
	{	   
	...
	/// </summary>
	[Serializable]
	public partial class AnimalsSpecy : RepositoryRecord<AnimalsSpecy>, IRecordBase
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("AnimalsSpecies", TableType.Table, DataService.GetInstance("SSRepository"));
				...
				DataService.Providers["SSRepository"].AddSchema("AnimalsSpecies",schema);
			}
		}
		#endregion
