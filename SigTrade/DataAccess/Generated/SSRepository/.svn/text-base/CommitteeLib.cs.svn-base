...
namespace SignificantTradeSSRepository
{
	...
	/// </summary>
    [Serializable]
	public partial class CommitteeLibCollection : RepositoryList<CommitteeLib, CommitteeLibCollection>
	{	   
	...
	/// </summary>
	[Serializable]
	public partial class CommitteeLib : RepositoryRecord<CommitteeLib>, IRecordBase
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("CommitteeLib", TableType.Table, DataService.GetInstance("SSRepository"));
				...
				DataService.Providers["SSRepository"].AddSchema("CommitteeLib",schema);
			}
		}
		#endregion
