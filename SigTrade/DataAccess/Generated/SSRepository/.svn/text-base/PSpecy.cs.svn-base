...
namespace SignificantTradeSSRepository
{
	...
	/// </summary>
    [Serializable]
	public partial class PSpecyCollection : RepositoryList<PSpecy, PSpecyCollection>
	{	   
	...
	/// </summary>
	[Serializable]
	public partial class PSpecy : RepositoryRecord<PSpecy>, IRecordBase
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("PSpecies", TableType.Table, DataService.GetInstance("SSRepository"));
				...
				DataService.Providers["SSRepository"].AddSchema("PSpecies",schema);
			}
		}
		#endregion
