...
namespace SignificantTradeSSRepository
{
	...
	/// </summary>
    [Serializable]
	public partial class AGenuCollection : RepositoryList<AGenu, AGenuCollection>
	{	   
	...
	/// </summary>
	[Serializable]
	public partial class AGenu : RepositoryRecord<AGenu>, IRecordBase
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("AGenus", TableType.Table, DataService.GetInstance("SSRepository"));
				...
				DataService.Providers["SSRepository"].AddSchema("AGenus",schema);
			}
		}
		#endregion
