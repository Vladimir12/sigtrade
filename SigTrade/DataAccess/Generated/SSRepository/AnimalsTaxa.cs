...
namespace SignificantTradeSSRepository{
    /// <summary>
    /// Strongly-typed collection for the AnimalsTaxa class.
    /// </summary>
    [Serializable]
    public partial class AnimalsTaxaCollection : ReadOnlyList<AnimalsTaxa, AnimalsTaxaCollection>
    {        
        public AnimalsTaxaCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the vwAnimalsTaxa view.
    /// </summary>
    [Serializable]
    public partial class AnimalsTaxa : ReadOnlyRecord<AnimalsTaxa>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vwAnimalsTaxa", TableType.View, DataService.GetInstance("SSRepository"));
                ...
                colvarOrdRecID.IsNullable = true;
                ...
                colvarClaRecID.IsNullable = true;
                ...
                colvarPhyRecID.IsNullable = true;
                ...
                colvarKgmRecID.IsNullable = true;
                ...
                DataService.Providers["SSRepository"].AddSchema("vwAnimalsTaxa",schema);
            }
        }
        #endregion
        ...
        public AnimalsTaxa(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public AnimalsTaxa(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public AnimalsTaxa(string columnName, object columnValue)
        {
            SetSQLProps();
