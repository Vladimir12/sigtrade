...
namespace SignificantTradeSSRepository
{
	...
	/// </summary>
    [Serializable]
	public partial class CommentCollection : RepositoryList<Comment, CommentCollection>
	{	   
	...
	/// </summary>
	[Serializable]
	public partial class Comment : RepositoryRecord<Comment>, IRecordBase
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Comments", TableType.Table, DataService.GetInstance("SSRepository"));
				...
				DataService.Providers["SSRepository"].AddSchema("Comments",schema);
			}
		}
		#endregion
