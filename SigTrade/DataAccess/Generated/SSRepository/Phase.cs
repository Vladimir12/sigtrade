...
namespace SignificantTradeSSRepository
{
	...
	/// </summary>
    [Serializable]
	public partial class PhaseCollection : RepositoryList<Phase, PhaseCollection>
	{	   
	...
	/// </summary>
	[Serializable]
	public partial class Phase : RepositoryRecord<Phase>, IRecordBase
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Phase", TableType.Table, DataService.GetInstance("SSRepository"));
				...
				DataService.Providers["SSRepository"].AddSchema("Phase",schema);
			}
		}
		#endregion
