...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
 ...
 {%>
    ...
    <td><%=Html.Encode(String.Format("{0:d MMM, yyyy}",m.MeetingLibDate))%> </td>
    <td>
   <%= Html.ActionLink("__IMAGE_PLACEHOLDER__", "Edit", new { controller = "Meetings", ID = m.GetPrimaryKeyValue()}).Replace("__IMAGE_PLACEHOLDER__", "<img alt='edit meeting' title='edit meeting' src=\"" + "/Content/images/icons/page_edit.png" + "\" />")%>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ControlsContent" runat="server">
    <%= Html.ActionLink("__IMAGE_PLACEHOLDER__" + Resources.SigTrade.buttonCreateNewCommittee, "Create", null, new { @class = "button positive" }).Replace("__IMAGE_PLACEHOLDER__", "<img alt='add meeting' title='add meeting' src=\"" + "/Content/images/icons/add.png" + "\" />")%> 
</asp:Content>
