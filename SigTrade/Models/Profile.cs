...
namespace SigTrade {
    ...
    public partial class Profile {
        ...
        public Profile(System.Web.Profile.ProfileBase profileBase) {
        ...
        public virtual string last_name {
            get {
                return ((string)(this.GetPropertyValue("last_name")));
            }
            set {
                this.SetPropertyValue("last_name", value);
            }
        }
        ...
        public virtual string organization {
            get {
                return ((string)(this.GetPropertyValue("organization")));
            }
            set {
        ...
        public virtual string address_1 {
            get {
                return ((string)(this.GetPropertyValue("address_1")));
            }
            set {
                this.SetPropertyValue("address_1", value);
            }
        }
        
        public virtual string address_3 {
            get {
                return ((string)(this.GetPropertyValue("address_3")));
            }
            set {
                this.SetPropertyValue("address_3", value);
            }
        }
        
        public virtual string address_2 {
            get {
                return ((string)(this.GetPropertyValue("address_2")));
            }
            set {
                this.SetPropertyValue("address_2", value);
            }
        }
        
        public virtual string town {
            get {
                return ((string)(this.GetPropertyValue("town")));
            }
            set {
                this.SetPropertyValue("town", value);
            }
        }
        
        public virtual int country_id {
            get {
                return ((int)(this.GetPropertyValue("country_id")));
            }
            set {
                this.SetPropertyValue("country_id", value);
            }
        }
        
        public static Profile Current {
            get {
                return new Profile(System.Web.HttpContext.Current.Profile);
            }
        }
        ...
        public static Profile GetProfile(string username) {
            return new Profile(System.Web.Profile.ProfileBase.Create(username));
        }
        
        public static Profile GetProfile(string username, bool authenticated) {
            return new Profile(System.Web.Profile.ProfileBase.Create(username, authenticated));
        }
